...
// Store active listings globally for editing
...
function renderServices(services, whatsappNum) {
    ...
    services.forEach(service => {
        ...
        // Admin Management List Item (with Edit Button)
...
function resetServiceForm() {
    ...
    document.getElementById('drop-zone-service-label').innerHTML = `<i class="fa-solid fa-cloud-arrow-up"></i> Select/Drop <strong>New Image</strong>`;
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add / Update Apartment Listing Form
    document.getElementById('service-form').addEventListener('submit', async (e) => {
        ...
        // If user uploaded a new image, send to Supabase Storage
